...
import type { Product as _Product, Testimonial as _Testimonial, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createInquiry(arg0: string, arg1: string, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getTestimonialByAuthor(arg0: string): Promise<Testimonial | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTestimonialByAuthor(arg0);
    ...
    async listNewsletterSignups(): Promise<Array<NewsletterSignup>> {
        if (this.processError) {
            try {
                const result = await this.actor.listNewsletterSignups();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async subscribeToNewsletter(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateTestimonial(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
